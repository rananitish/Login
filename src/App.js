      ...
      <div className="log-details">
        <form id ="loginForm" action="" method="post">
         <div className="form-element-wrapper">
           <input className='form-input' autoComplete='off' name='login_user_Username' type="email" name="" id="email" placeHolder="Email Address or Phone Number"/>
           <label htmlFor="email address" className="form-label">Email Address or Phone Number</label>
         </div>
         <div className="form-element-wrapper">
           <input type="password" name="login_user_Password" id="login-password" autoComplete="off" className="form-input" placeholder="Password"   />
